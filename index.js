...
app.get('/dashboard', (req, res) => {
  if (!userIdGlobal) {
    ...
    const promise = databases.listDocuments('selllab-database-2024', 'visitor-2024');
    promise
      .then(function (response) {
        console.log(response); // Affiche la réponse complète dans la console

        // Filtrer les documents en fonction de l'ID utilisateur et de l'ID de la boutique
        const filteredDocuments = response.documents.filter(
          (document) => document.shopId === shopId
        );
        ...
        // Générer le code HTML correspondant aux documents filtrés
        let html = `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <aside class="aside-container">
              ...
              <div class="menu-box">
                  <a href="/onboard" class="list-menu-box">
              ...
              <aside class="main-container-aside">
                  <div class="menu-box">
                      <a href="/overview" class="list-menu-box menu-active">
                          <img src="logo/nike-logo-removebg-preview (1).png" alt="" class="overview-store-image">
                          <span>Sparkle inc.</span>
                      </a>
                  </div>
                  <div class="menu-box">
                      <a href="/orders" class="list-menu-box">
                  ...
                  <div class="menu-box">
                      <a href="/add-product" class="list-menu-box">
                  ...
                  <div class="menu-box">
                      <a href="/builder" class="list-menu-box">
